  ...
  <body>
    ...
    <main class="page-wrapper">
      ...
      <section class="container pb-5 mb-md-3 mb-lg-5">
        <div class="row align-items-center">
          <div class="col-xl-5 col-md-6 offset-xl-1 order-md-2 text-center text-md-start mb-3 mb-sm-0">
            ...
            <p class="fs-xl d-md-none d-lg-block pb-2 pb-md-4 mb-lg-3">1. Follow @bmorecoin 2. Tweet "This is going to be a great message one day, #Baltimore #Blockchain $BALTx 3. Click ] HERE [ to confirm and claim you 1,000 BALTx for today!</p>
      ...
      <section class="container pb-5 mb-md-4 mb-lg-5">
        <h2 class="h1 text-center pb-4">Our Customers</h2>
        <div class="position-relative pt-md-5 mt-md-n5">
          <div class="position-absolute top-50 start-0 w-100 text-center mt-sm-n5">
            <h3 class="h2 mx-auto mt-n5" style="max-width: 572px;">
              Trusted by leading global companies <span class="text-primary">48+</span> customers in <span class="text-primary">9+</span> countries
            </h3>
          </div>
              ...
              <div class="col-lg-4">
                ...
                <div id="useful-links" class="collapse d-lg-block" data-bs-parent="#footer-links">
                  <ul class="nav flex-column pb-lg-1 mb-lg-3">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">Works</a></li>
